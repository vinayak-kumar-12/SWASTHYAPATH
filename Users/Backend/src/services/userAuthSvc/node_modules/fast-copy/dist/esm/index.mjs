 ...
 */
var MaxDepthExceededError = /** @class */ (function (_super) {
    __extends(MaxDepthExceededError, _super);
    function MaxDepthExceededError(maxDepth) {
        var _this = _super.call(this, 'Maximum copy depth of ' +
            String(maxDepth) +
            ' exceeded; the value copied is nested too deeply.') || this;
        ...
        if (setPrototypeOf) {
            setPrototypeOf(_this, MaxDepthExceededError.prototype);
        }
 ...
 *
 * @note
 * This is deliberately below the depth at which the native call stack is exhausted, so that
 * untrusted, deeply-nested values fail with a catchable, descriptive error instead of a raw
 * `RangeError`.
 */
    ...
    function copier(value, state) {
        ...
        if (!state.Constructor || state.Constructor === Object) {
            ...
            if (tagSpecificCopier) {
                ...
                clone =
                    typeof value.then === 'function' ? value : copyObject(value, state);
            }
        }
        --state.depth;
        return clone;
...
export { MaxDepthExceededError, copyStrict, createCopier, createStrictCopier, index as default };
